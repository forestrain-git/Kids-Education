...
var KNOWLEDGE_NODES = [
  // 八上 第1章 机械运动
  { id: 'motion_measurement', name: '长度和时间的测量', chapter: '机械运动', semester: '上', order: 1 },
  { id: 'motion_reference', name: '参照物', chapter: '机械运动', semester: '上', order: 2 },
  { id: 'motion_speed', name: '速度', chapter: '机械运动', semester: '上', order: 3 },
  { id: 'motion_avg_speed', name: '平均速度测量', chapter: '机械运动', semester: '上', order: 4 },

  // 八上 第2章 声现象
  { id: 'sound_production', name: '声音的产生与传播', chapter: '声现象', semester: '上', order: 5 },
  { id: 'sound_characteristics', name: '声音的特性', chapter: '声现象', semester: '上', order: 6 },
  { id: 'sound_utilization', name: '声的利用', chapter: '声现象', semester: '上', order: 7 },
  { id: 'sound_noise', name: '噪声的控制', chapter: '声现象', semester: '上', order: 8 },

  // 八上 第3章 物态变化
  { id: 'temp_measurement', name: '温度', chapter: '物态变化', semester: '上', order: 9 },
  { id: 'phase_melt', name: '熔化和凝固', chapter: '物态变化', semester: '上', order: 10 },
  { id: 'phase_vapor', name: '汽化和液化', chapter: '物态变化', semester: '上', order: 11 },
  { id: 'phase_sublime', name: '升华和凝华', chapter: '物态变化', semester: '上', order: 12 },

  // 八下 力与运动
  { id: 'force_concept', name: '力的概念', chapter: '力与运动', semester: '下', order: 13 },
  { id: 'force_effect', name: '力的作用效果', chapter: '力与运动', semester: '下', order: 14 },
  { id: 'force_interaction', name: '力的作用是相互的', chapter: '力与运动', semester: '下', order: 15 },
  { id: 'elastic_concept', name: '弹力', chapter: '力与运动', semester: '下', order: 16 },
  { id: 'elastic_measurement', name: '弹簧测力计', chapter: '力与运动', semester: '下', order: 17 },
  { id: 'elastic_hooke', name: '胡克定律', chapter: '力与运动', semester: '下', order: 18 },
  { id: 'gravity_concept', name: '重力', chapter: '力与运动', semester: '下', order: 19 },
  { id: 'gravity_calculation', name: '重力的计算', chapter: '力与运动', semester: '下', order: 20 },
  { id: 'gravity_center', name: '重心', chapter: '力与运动', semester: '下', order: 21 },
  { id: 'newton_first', name: '牛顿第一定律', chapter: '力与运动', semester: '下', order: 22 },
  { id: 'inertia_concept', name: '惯性', chapter: '力与运动', semester: '下', order: 23 },
  { id: 'inertia_application', name: '惯性的应用', chapter: '力与运动', semester: '下', order: 24 },
  { id: 'balance_condition', name: '二力平衡条件', chapter: '力与运动', semester: '下', order: 25 },
  { id: 'balance_friction', name: '摩擦力与平衡', chapter: '力与运动', semester: '下', order: 26 },
  { id: 'friction_concept', name: '摩擦力', chapter: '力与运动', semester: '下', order: 27 },
  { id: 'friction_factors', name: '影响摩擦力的因素', chapter: '力与运动', semester: '下', order: 28 },
  { id: 'friction_application', name: '摩擦力的应用', chapter: '力与运动', semester: '下', order: 29 },
];
